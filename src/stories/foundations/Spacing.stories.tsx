...
const RADIUS = [
  {
    token: '--radius-none',
    value: '0',
    label: 'Terminal chrome — nav underlines, horizontal rules',
  },
...
const BORDERS = [
  {
    ...
    color: '#1c1f1a',
    desc: 'Barely visible — default card/panel edges',
  },
...
const MOTION = [
  ...
  { token: '--duration-slow', value: '250ms', desc: 'Panel transitions, menu open' },
  {
    ...
    desc: 'All transitions — standard ease',
  },
];
  ...
  render: () => (
    <div style={{ background: s.bg, padding: '48px', fontFamily: s.fontMono, minHeight: '100vh' }}>
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        >
          Base-4 spacing scale, border radius, border styles, and motion tokens. Sharp aesthetic —
          3px radius is the system default, 0 for terminal chrome.
        </div>
      </div>
