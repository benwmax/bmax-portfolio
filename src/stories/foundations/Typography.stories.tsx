  ...
  render: () => (
    <div style={{ background: s.bg, padding: '48px', fontFamily: s.fontMono, minHeight: '100vh' }}>
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        >
          Two-font mono system. Space Mono for UI chrome and display; IBM Plex Mono for functional
          text at small sizes. System sans reserved for prose — never for navigation or labels.
        </div>
      </div>
      ...
      {LEADING.map(({ token, value, note }) => (
        ...
        >
          <div>
            <div style={{ fontFamily: s.fontMono, fontSize: '0.6875rem', color: s.textTert }}>
              {token}
            </div>
            <div
              style={{
