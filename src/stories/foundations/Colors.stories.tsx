...
function PageHeader() {
  return (
    <div style={{ marginBottom: 8 }}>
      ...
      >
        Full token palette. Dark mode is the primary experience — no light mode override yet. Two
        accent families: phosphor green (interactive) and warm amber (callouts, industry tags).
      </div>
    </div>
  );
}
...
const BACKGROUNDS: SwatchRow[] = [
  ...
  { variable: '--color-bg-dot', hex: '#232620', description: 'Dot grid pattern color' },
  {
    ...
    hex: '#0e100fcc',
    description: 'Modals, overlays (80% opacity)',
  },
];
...
const BORDERS: SwatchRow[] = [
  { variable: '--color-border-subtle', hex: '#1c1f1a', description: 'Default card/panel borders' },
  {
    ...
    hex: '#2c3028',
    description: 'Input borders, visible dividers',
  },
  {
    variable: '--color-border-strong',
    hex: '#3d4035',
    description: 'Emphasized borders, hover states',
  },
];
...
const GREEN: SwatchRow[] = [
  {
    variable: '--color-green-deepest',
    hex: '#041a0a',
    description: 'Darkest bg tint — hover states',
  },
  { variable: '--color-green-deep', hex: '#062010', description: 'Button backgrounds' },
  {
    variable: '--color-green-border',
    hex: '#0e4a1e',
    description: 'Button borders, input focus rings',
  },
  { variable: '--color-green-mid', hex: '#1a8032', description: 'Mid-range, progress fills' },
  {
    variable: '--color-green-accent',
    hex: '#00e054',
    description: 'Primary accent — buttons, links, active nav',
  },
  {
    variable: '--color-green-bright',
    hex: '#00ff5e',
    description: 'Max contrast — cursor blink, status dot, caret',
  },
  {
    variable: '--color-green-light',
    hex: '#80eea0',
    description: 'Lightest — subtle highlights, tags',
  },
];
...
const AMBER: SwatchRow[] = [
  ...
  {
    variable: '--color-amber-accent',
    hex: '#c08820',
    description: 'Primary amber — tags, callouts',
  },
  {
    variable: '--color-amber-bright',
    hex: '#e0a840',
    description: 'Bright amber — emphasized values',
  },
];
...
const SEMANTIC: SwatchRow[] = [
  ...
  { variable: '--color-status-warning', hex: '#c08820', description: 'Status — warning' },
  {
    ...
    hex: '#e05050',
    description: 'Error — actual errors only, not warnings',
  },
